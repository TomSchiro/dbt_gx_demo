 ...
 FROM SNOWFLAKE_SAMPLE_DATA.TPCDS_SF10TCL.CUSTOMER  cust
 INNER JOIN SNOWFLAKE_SAMPLE_DATA.TPCDS_SF10TCL.CUSTOMER_ADDRESS  addr
ON cust.C_CURRENT_ADDR_SK = CA_ADDRESS_SK
INNER JOIN SNOWFLAKE_SAMPLE_DATA.TPCDS_SF10TCL.CUSTOMER_DEMOGRAPHICS  demo
